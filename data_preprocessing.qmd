...
raw_oct <- read.delim("data/order_202410.txt")
raw_nov <- read.delim("data/order_202411.txt")
...
sku_ref <- read.csv("data/sku_chart.csv")
...
saveRDS(revenue_data, "data/revenue_summary_tidied.rds")
```
